  ...
  series: [
    {
      ...
      links: [
        { source: 'aisle 1', target: 'aisle 2', weight: 5 },
        { source: 'aisle 2', target: 'aisle 1', weight: 5 },
        { source: 'aisle 1', target: 'bin 1', weight: 2 },
        { source: 'bin 1', target: 'aisle 1', weight: 2 },
        { source: 'bin 1', target: 'bin 2', weight: 2 },
        { source: 'bin 2', target: 'bin 1', weight: 2 },
        { source: 'bin 2', target: 'bin 3', weight: 2 },
        { source: 'bin 3', target: 'bin 2', weight: 2 },
        { source: 'bin 3', target: 'bin 6', weight: 2 },
        { source: 'bin 6', target: 'bin 3', weight: 2 },
        { source: 'aisle 2', target: 'bin 4', weight: 2 },
        { source: 'bin 4', target: 'aisle 2', weight: 2 },
        { source: 'bin 4', target: 'bin 5', weight: 2 },
        { source: 'bin 5', target: 'bin 4', weight: 2 },
        { source: 'bin 5', target: 'bin 6', weight: 2 },
        { source: 'bin 6', target: 'bin 5', weight: 2 },
        { source: 'bin 6', target: 'bin 9', weight: 2 },
        { source: 'bin 9', target: 'bin 6', weight: 2 },
        { source: 'aisle 2', target: 'aisle 3', weight: 5 },
        { source: 'aisle 3', target: 'aisle 2', weight: 5 },
        { source: 'aisle 3', target: 'bin 7', weight: 2 },
        { source: 'bin 7', target: 'aisle 3', weight: 2 },
        { source: 'bin 7', target: 'bin 8', weight: 2},
        { source: 'bin 8', target: 'bin 7', weight: 2},
        { source: 'bin 8', target: 'bin 9', weight: 2 },
        { source: 'bin 9', target: 'bin 8', weight: 2 },
        { source: 'bin 9', target: 'bin 12', weight: 2 },
        { source: 'bin 12', target: 'bin 9', weight: 2 },
        { source: 'aisle 3', target: 'aisle 4', weight: 5 },
        { source: 'aisle 4', target: 'aisle 3', weight: 5 },
        { source: 'aisle 4', target: 'bin 10', weight: 2},
        { source: 'bin 10', target: 'aisle 4', weight: 2},
        { source: 'bin 10', target: 'bin 11', weight: 2},
        { source: 'bin 11', target: 'bin 10', weight: 2},
        { source: 'bin 11', target: 'bin 12', weight: 2 },
        { source: 'bin 12', target: 'bin 11', weight: 2 }
      ],
      lineStyle: {
        opacity: 0.9,
        width: 2,
...
function dijkstra(graph, startNode, obstacles) {
  let distances = {};
  let prev = {};
...
let startNode = 'aisle 1';
let endNode = 'bin 12';
let obstacles = ['bin 6']; // Example obstacle
